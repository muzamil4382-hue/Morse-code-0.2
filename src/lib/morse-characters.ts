...
export const letterData: MorseCharacterData[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    introduction:
      "The letter E in Morse code is the simplest of all characters: a single dot (·). This brevity is no accident — Samuel Morse and Alfred Vail deliberately assigned the shortest code to the most frequently used letter in the English language. The letter E appears in approximately 12.7% of all English text, making it by far the most common letter, more than twice as frequent as the next runner-up, T. In fact, roughly one out of every eight characters you encounter in English text is an E, which means that in Morse code communication, the single dot is the signal you will hear most often. This elegant efficiency is a hallmark of Morse code design: the most needed signals are the easiest to send and recognize, optimizing communication speed. You can practice this pattern with the [Morse Code Translator](/) and explore the [Morse Code Alphabet](/morse-code-alphabet). It is also useful to compare it with [T in Morse Code](/morse-code-letter/t) and [A in Morse Code](/morse-code-letter/a).",
    soundRhythm:
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    introduction:
      "The letter I in Morse code is represented by two dots (··). This simple two-element pattern makes I the second shortest letter code in the entire Morse code alphabet, surpassed only by E (single dot) and tied with several other two-element characters. In the NATO phonetic alphabet, I is designated as \"India,\" a word used extensively in military, aviation, and maritime communications. The letter I appears in approximately 7.0% of English text, making it the fourth most common letter — its high frequency combined with its short code is another example of Morse code's efficient design. The two-dot pattern is quick, clean, and easy to both send and receive, making I an excellent letter for beginners to practice after learning E and T. You can practice this pattern with the [Morse Code Translator](/) and explore the [Morse Code Alphabet](/morse-code-alphabet). It is also useful to compare it with [S in Morse Code](/morse-code-letter/s) and [E in Morse Code](/morse-code-letter/e).",
    soundRhythm:
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    introduction:
      "The letter N in Morse code is represented by a dash followed by a dot (−·). This two-element pattern is the exact mirror image of the letter A (·−, dot-dash) — they have the same two elements in reverse order. In the NATO phonetic alphabet, N is designated as \"November,\" a word universally recognized from military, aviation, and maritime contexts. The letter N appears in approximately 6.7% of English text, making it the sixth most common letter and one you will encounter frequently in Morse code communication. N's dash-dot pattern creates a strong-then-light rhythm that contrasts with A's light-then-strong feel, and this mirror relationship makes N and A an excellent pair to practice together when learning Morse code. You can practice this pattern with the [Morse Code Translator](/) and explore the [Morse Code Alphabet](/morse-code-alphabet). It is also useful to compare it with [A in Morse Code](/morse-code-letter/a) and [D in Morse Code](/morse-code-letter/d).",
    soundRhythm:
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    introduction:
      "The letter T in Morse code is represented by a single dash (−). This simplicity makes T the second shortest letter code in the entire Morse code system, surpassed only by E (single dot). The brevity of T's code reflects its importance in the English language — T is the second most common letter, appearing in approximately 9.1% of all English text. In the NATO phonetic alphabet, T is designated as \"Tango,\" a word familiar from military, aviation, and countless movies and television shows. The single-dash pattern means that roughly one out of every eleven characters in any Morse code transmission will be a simple, sustained tone. T's simplicity makes it an ideal letter for beginners and an essential building block for understanding the dash as a fundamental Morse code element. You can practice this pattern with the [Morse Code Translator](/) and explore the [Morse Code Alphabet](/morse-code-alphabet). It is also useful to compare it with [E in Morse Code](/morse-code-letter/e) and [M in Morse Code](/morse-code-letter/m).",
    soundRhythm:
...
export const numberData: MorseCharacterData[] = [
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    introduction:
      "The number 3 in Morse code is represented by three dots followed by two dashes (···−−). This five-element pattern occupies the midpoint of the Morse code number system's progressive design — three dots on the way to five, followed by two dashes. The pattern creates a balanced feel: three light elements transitioning to two heavy ones. The number 3 appears constantly in Morse code communication through frequencies (e.g., 3.5 MHz for the 80-meter amateur radio band), times, dates, coordinates, and measurements. Understanding 3's pattern (three dots, two dashes) is a key milestone because it represents the turning point in the number system — from here, numbers 4 and 5 continue adding dots, while 6-0 reverse the pattern with dashes leading. You can practice this pattern with the [Morse Code Translator](/) and explore the [Morse Code Numbers](/morse-code-numbers). It is also useful to compare it with [4 in Morse Code](/morse-code-number/4) and [V in Morse Code](/morse-code-letter/v).",
    soundRhythm:
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    introduction:
      "The number 7 in Morse code is represented by two dashes followed by three dots (−−···). This five-element pattern continues the reverse phase of the Morse code number system with two leading dashes and three trailing dots. The pattern creates a heavy opening that transitions to lighter elements — two sustained tones followed by three quick taps. The number 7 appears frequently in Morse code communication through the 7 MHz amateur radio band (the most popular HF band for worldwide communication), time designations (07:00, 1700), frequencies, and coordinates. Understanding 7's pattern (two dashes, three dots) reinforces the systematic progression of the number system and its relationship to nearby characters like Z (−−··) and G (−−·). You can practice this pattern with the [Morse Code Translator](/) and explore the [Morse Code Numbers](/morse-code-numbers). It is also useful to compare it with [Z in Morse Code](/morse-code-letter/z) and [G in Morse Code](/morse-code-letter/g).",
    soundRhythm:
