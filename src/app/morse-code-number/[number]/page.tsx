...
// ─── Renders Markdown-style internal links ──────────────────────────────
// Example:
...
export default async function LetterPage({
  ...
  const title =
    data?.title ||
    `${char} in Morse Code: Complete Guide & Translation`;
    ...
    data?.faq || [
      ...
      },
      {
        ...
        answer: `The letter ${char} uses ${elemCount} element${
          ...
          elemCount <= 2
            ? "one of the easier letters to learn"
            : elemCount <= 3
            ? "a moderately easy letter to master"
            : "a slightly more complex letter that requires more practice"
        }. The key to learning ${char} is to focus on its rhythm — "${ditDah}" — rather than trying to memorize individual dots and dashes.`,
      },
    ];
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8 md:py-12">
          ...
          <section className="mb-10">
            ...
            <div className="prose-content text-slate-600 leading-relaxed space-y-4">
              <p>
                {renderInlineLinks(introduction)}
              </p>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="prose-content text-slate-600 leading-relaxed space-y-4">
              <p>
                {renderInlineLinks(practiceTips)}
              </p>
            </div>
          ...
          <section className="mb-10">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              ...
              {relatedSlugs.map((slug) => {
                ...
                const relatedChar =
                  extractCharFromSlug(slug);

                const relatedData =
                  getCharData(relatedChar);

                const relatedCode =
                  relatedData?.code ||
                  MORSE_CODE[relatedChar] ||
                  "";
