      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8 md:py-12">
            ...
            {!submitted ? (
              ...
              >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="inline-flex items-center gap-2 px-6 py-3 bg-green-600 text-white rounded-lg font-medium hover:bg-green-700 transition-colors shadow-sm shadow-green-600/20 cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
                >
            ...
            {[
              {
                ...
                a: "We don't currently offer a public API, but it's something we're considering for the future. If you're interested, let us know through the contact form.",
              },
              {
                q: "Can I suggest a new feature?",
                a: "Absolutely! We love hearing from our users. Use the form above to submit your ideas and we'll consider them for future updates.",
              },
              {
                q: "I found an error on the site. How do I report it?",
                a: "Please use the contact form above and select 'Bug Report' or similar in the subject line. We'll fix it as soon as possible.",
              },
            ].map((faq, i) => (
              <div
                key={i}
        ...
        <div className="mt-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            <Link
              href="/"
              className="p-4 bg-green-50 border border-green-200 rounded-lg text-green-700 font-medium hover:bg-green-100 transition-colors"
            >
              🔤 Morse Translator
            </Link>
